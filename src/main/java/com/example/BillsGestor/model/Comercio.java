...
public class Comercio {
    ...
    public Comercio(Integer id, String nit, String nombre, String actividad, String contacto, String direccion,
            String ciudad, LocalDate fechaRegistro, String estado, String regimenTributario, List<Gasto> gastos) {
        this.id = id;
        this.nit = nit;
        this.nombre = nombre;
